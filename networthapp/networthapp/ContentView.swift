...
//  networthapp
//
//  Created by Stuckware on 05/12/22.
//
...
struct AccountAddView : View {
    ...
    func postAccount() {
        ...
        let accountData = Account(id: 0, name: self.name, category: self.category, description: self.description, wealth_type: self.wealth_type, balance: Int(self.balance) ?? 0, created_at: "", updated_at: "")
